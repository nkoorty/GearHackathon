...
class JsonViewController: UIViewController, UIDocumentPickerDelegate {
    ...
    lazy var textLabel: UILabel = {
        let label = UILabel()
        label.layout(colour: .white, size: 18, text: "So that we can safely log you in, please upload an exported .json file from your Polkadot.js wallet, and provide your password. If you don't have a Polkadot.js wallet yet, check out Polkadot.js here.", bold: false)
    ...
    func documentPicker(_ controller: UIDocumentPickerViewController, didPickDocumentsAt urls: [URL]) {
        ...
        do {
            ...
            DispatchQueue.main.async {
                self.jsonView.uploadLabel.text = "Imported from Polkadot.js"
                self.jsonView.descriptionLabel.text = fileNameWithoutExtension
            }
        } catch {
    ...
    func setUpView() {
        ...
        jsonView.anchor(top: textLabel.bottomAnchor, paddingTop: 44, bottom: nil, paddingBottom: 0, left: view.leftAnchor, paddingLeft: 16, right: view.rightAnchor, paddingRight: 16, width: 0, height: 200)
        
        searchBar.anchor(top: jsonView.bottomAnchor, paddingTop: 12, bottom: nil, paddingBottom: 0, left: jsonView.leftAnchor, paddingLeft: 0, right: jsonView.rightAnchor, paddingRight: 0, width: 0, height: 50)
        
        submitButton.anchor(top: searchBar.bottomAnchor, paddingTop: 28, bottom: nil, paddingBottom: 0, left: view.leftAnchor, paddingLeft: 16, right: view.rightAnchor, paddingRight: 16, width: 0, height: 50)
